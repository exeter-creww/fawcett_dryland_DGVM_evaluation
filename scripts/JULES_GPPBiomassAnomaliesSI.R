...
GPPstack <- stack("D:/Driving_C/PMLV2sampled/PMLv2GPPstack10knew.tif")
  ...
  cVegmodelpath <- 'JULES-ES.1p0.vn5.4.50.CRUJRA2.TRENDYv8.365.S3_Annual_cVeg.nc'
  cSoilmodelpath <- 'JULES-ES.1p0.vn5.4.50.CRUJRA2.TRENDYv8.365.S3_Annual_cSoil.nc'
  ...
  lcfraster <- rotate(lcfraster)  #JULES coordinates go from 0 to 360, raster needs to be shifted
  ...
  PMLdatamask[PMLdatamask ==0] <- NA
   ...
   modelannualcSoilmasked <- modelannualcSoil*10
    ...
    write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/JULES_dryland_GPP_1901_2018.csv",sep=",",row.names = F)
    ...
    write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/JULES_dryland_cVeg_2011_2018.csv",sep=",",row.names = F)
    ...
    write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/JULES_dryland_cVeg_2011_2018_extended.csv",sep=",",row.names = F)
    ...
    write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/JULES_dryland_cVeg_2011_2018_contained.csv",sep=",",row.names = F)
    ...
    write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/JULES_dryland_cVeg_1901_2018.csv",sep=",",row.names = F)
    ...
    write.table(dfdrylandcSoil,"D:/Driving_C/DGVM/DGVMdrylandTS/cSoil/JULES_dryland_cSoil_1901_2018.csv",sep=",",row.names = F)
