...
GPPstack <- stack("D:/Driving_C/PMLV2sampled/PMLv2GPPstack10knew.tif")
  ...
  gppmodelpath <- 'ISBA-CTRIP_S1_gpp.nc'
  cVegmodelpath <- 'ISBA-CTRIP_S1_cVeg.nc'
  lcpath <- 'ISBA-CTRIP_sftlf.nc'
  cSoilmodelpath <- 'ISBA-CTRIP_S1_cSoil.nc'
  ...
  monthyearindexgpp <- rep(1:118,each=12)
  ...
  PMLdatamask[PMLdatamask ==0] <- NA
   ...
   modelannualcSoilmasked <- modelannualcSoil*10
    ...
    write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/ISBA-CTRIP_S1_dryland_GPP_1901_2018.csv",sep=",",row.names = F)
    ...
    write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/ISBA-CTRIP_S1_dryland_GPP_2003_2018_extended.csv",sep=",",row.names = F)
    ...
    write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/ISBA-CTRIP_S1_dryland_GPP_2003_2018_contained.csv",sep=",",row.names = F)
    ...
    write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/ISBA-CTRIP_S1_dryland_cVeg_2011_2018.csv",sep=",",row.names = F)
    ...
    write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/ISBA-CTRIP_S1_dryland_cVeg_2011_2018_extended.csv",sep=",",row.names = F)
    ...
    write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/ISBA-CTRIP_S1_dryland_cVeg_2011_2018_contained.csv",sep=",",row.names = F)
    ...
    write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/ISBA-CTRIP_S1_dryland_cVeg_1901_2018.csv",sep=",",row.names = F)
    ...
    write.table(dfdrylandcSoil,"D:/Driving_C/DGVM/DGVMdrylandTS/cSoil/ISBA-CTRIP_S1_dryland_cSoil_1901_2018.csv",sep=",",row.names = F)