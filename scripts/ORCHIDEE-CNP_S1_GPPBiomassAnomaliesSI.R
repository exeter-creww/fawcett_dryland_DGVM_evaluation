...
#contnrlist <- c(1,6,3,4)#number in continent shapefiles
  ...
  cLittermodelpath <- 'ORCHIDEE-CNP_S1_cLitter.nc'
  cCwdmodelpath <- 'ORCHIDEE-CNP_S1_cCwd.nc'
  
  #lcpath <- 'ORCHIDEE-CNP_S1_S3_oceanCoverFrac.nc'
  ...
  PMLdatamask[PMLdatamask ==0] <- NA
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/ORCHIDEE-CNP_S1_dryland_GPP_1901_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcLitter,"D:/Driving_C/DGVM/DGVMdrylandTS/cLitter/ORCHIDEE-CNP_S1_dryland_cLitter_1901_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcCwd,"D:/Driving_C/DGVM/DGVMdrylandTS/cCwd/ORCHIDEE-CNP_S1_dryland_cCwd_1901_2018.csv",sep=",",row.names = F)
