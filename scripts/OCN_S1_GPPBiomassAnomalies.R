...
#contnrlist <- c(1,6,3,4)#number in continent shapefiles
  ...
  cSoilmodelpath <- 'OCN_S1_cSoil.nc'
  ...
  PMLdatamask[PMLdatamask ==0] <- NA
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/OCN_S1_dryland_GPP_2003_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcSoil,"D:/Driving_C/DGVM/DGVMdrylandTS/cSoil/OCN_S1_dryland_cSoil_1901_2018.csv",sep=",",row.names = F)