...
DESCfiles <- list.files(paste0("./LVOD_WGS84/composites/median/DESC/"))
...
for(i in 1:(length(ASCfiles))){
  ...
  DESCraster <- raster(paste0("./LVOD_WGS84/composites/median/DESC/",DESCfiles[i]))
...
writeRaster(VODstack2,"./LVOD_WGS84/composites/median/VOD_ASC_annual_median_filtv2.tif",overwrite=T)
