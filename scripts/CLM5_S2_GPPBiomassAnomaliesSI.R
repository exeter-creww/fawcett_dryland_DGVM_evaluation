...
GPPstack <- stack("./PMLV2sampled/PMLv2GPPstack10knew.tif")
  ...
  gppmodelpath <- 'CLM5.0_S2_gpp.nc'
  cVegmodelpath <- 'CLM5.0_S2_cVeg.nc'
  #lcpath <- 'OCN_S3_oceanCoverFrac.nc'
  cLittermodelpath <- 'CLM5.0_S2_cLitter.nc'
  cCwdmodelpath <- 'CLM5.0_S2_cCwd.nc'
  ...
  extent(modelcLitterbrick) <- c(0, 360, -90, 90)
  projection(modelcLitterbrick) <- CRS("+init=epsg:4326")
  modelcLitterbrick <- rotate(modelcLitterbrick)
  
  extent(modelcCwdbrick) <- c(0, 360, -90, 90)
  projection(modelcCwdbrick) <- CRS("+init=epsg:4326")
  modelcCwdbrick <- rotate(modelcCwdbrick)
 ...
 # nc_close(lcncin)
  ...
  PMLdatamask[PMLdatamask ==0] <- NA
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/CLM5.0_S2_dryland_GPP_1901_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/CLM5.0_S2_dryland_GPP_2003_2018_extended.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/CLM5.0_S2_dryland_GPP_2003_2018_contained.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/CLM5.0_S2_dryland_cVeg_2011_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/CLM5.0_S2_dryland_cVeg_2011_2018_extended.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/CLM5.0_S2_dryland_cVeg_2011_2018_contained.csv",sep=",",row.names = F)
    ...
    write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/CLM5.0_S2_dryland_cVeg_1901_2018.csv",sep=",",row.names = F)
    ...
    write.table(dfdrylandcLitter,"D:/Driving_C/DGVM/DGVMdrylandTS/cLitter/CLM5.0_S2_dryland_cLitter_1901_2018.csv",sep=",",row.names = F)
    ...
    write.table(dfdrylandcCwd,"D:/Driving_C/DGVM/DGVMdrylandTS/cCwd/CLM5.0_S2_dryland_cCwd_1901_2018.csv",sep=",",row.names = F)
