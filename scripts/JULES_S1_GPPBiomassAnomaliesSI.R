...
GPPstack <- stack("D:/Driving_C/PMLV2sampled/PMLv2GPPstack10knew.tif")
  ...
  gppmodelpath <- 'JULES-ES.1p0.vn5.4.50.CRUJRA2.TRENDYv8.365.S1_Annual_gpp.nc'
  ...
  PMLdatamask[PMLdatamask ==0] <- NA
   ...
   modelannualcSoilmasked <- modelannualcSoil*10
    ...
    write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/JULES_S1_dryland_GPP_1901_2018.csv",sep=",",row.names = F)
