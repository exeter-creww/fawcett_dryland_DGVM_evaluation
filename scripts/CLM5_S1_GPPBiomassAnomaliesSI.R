...
GPPstack <- stack("./PMLV2sampled/PMLv2GPPstack10knew.tif")
  ...
  cLittermodelpath <- 'CLM5.0_S1_cLitter.nc'
  cCwdmodelpath <- 'CLM5.0_S1_cCwd.nc'
 ...
 # nc_close(lcncin)
  ...
  PMLdatamask[PMLdatamask ==0] <- NA
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/CLM5.0_S1_dryland_GPP_1901_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/CLM5.0_S1_dryland_GPP_2003_2018_extended.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/CLM5.0_S1_dryland_GPP_2003_2018_contained.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/CLM5.0_S1_dryland_cVeg_2011_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/CLM5.0_S1_dryland_cVeg_2011_2018_extended.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/CLM5.0_S1_dryland_cVeg_2011_2018_contained.csv",sep=",",row.names = F)
    ...
    write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/CLM5.0_S1_dryland_cVeg_1901_2018.csv",sep=",",row.names = F)
    ...
    write.table(dfdrylandcLitter,"D:/Driving_C/DGVM/DGVMdrylandTS/cLitter/CLM5.0_S1_dryland_cLitter_1901_2018.csv",sep=",",row.names = F)
    ...
    write.table(dfdrylandcCwd,"D:/Driving_C/DGVM/DGVMdrylandTS/cCwd/CLM5.0_S1_dryland_cCwd_1901_2018.csv",sep=",",row.names = F)
