...
GPPstack <- stack("D:/Driving_C/PMLV2sampled/PMLv2GPPstack10knew.tif")
  ...
  gppmodelpath <- 'DLEM_S3_gpp.nc'
  cVegmodelpath <- 'DLEM_S3_cVeg.nc'
  cLittermodelpath <- 'DLEM_S3_cLitter.nc'
  lcpath <- 'DLEM_landArea.nc'
  cCwdmodelpath <- 'DLEM_S3_cCwd.nc'
  ...
  write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/DLEM_dryland_GPP_1901_2018.csv",sep=",",row.names = F)
  ...
  write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/DLEM_dryland_GPP_2003_2018_extended.csv",sep=",",row.names = F)
  ...
  write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/DLEM_dryland_GPP_2003_2018_contained.csv",sep=",",row.names = F)
  ...
  write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/DLEM_dryland_cVeg_2011_2018.csv",sep=",",row.names = F)
  ...
  write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/DLEM_dryland_cVeg_2011_2018_extended.csv",sep=",",row.names = F)
  ...
  write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/DLEM_dryland_cVeg_2011_2018_contained.csv",sep=",",row.names = F)
  ...
  write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/DLEM_dryland_cVeg_1901_2018.csv",sep=",",row.names = F)
  ...
  write.table(dfdrylandcLitter,"D:/Driving_C/DGVM/DGVMdrylandTS/cLitter/DLEM_dryland_cLitter_1901_2018.csv",sep=",",row.names = F)
  ...
  write.table(dfdrylandcCwd,"D:/Driving_C/DGVM/DGVMdrylandTS/cCwd/DLEM_dryland_cCwd_1901_2018.csv",sep=",",row.names = F)
