...
#contnrlist <- c(1,6,3,4)#number in continent shapefiles
  ...
  gppmodelpath <- 'ORCHIDEE-CNP_S3_gpp.nc'
  cVegmodelpath <- 'ORCHIDEE-CNP_S3_cVeg.nc'
  cLittermodelpath <- 'ORCHIDEE-CNP_S3_cLitter.nc'
  cCwdmodelpath <- 'ORCHIDEE-CNP_S3_cCwd.nc'
  ...
  PMLdatamask[PMLdatamask ==0] <- NA
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/ORCHIDEE-CNP_dryland_GPP_1901_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/ORCHIDEE-CNP_dryland_GPP_2003_2018_extended.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/ORCHIDEE-CNP_dryland_GPP_2003_2018_contained.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/ORCHIDEE-CNP_dryland_cVeg_2011_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/ORCHIDEE-CNP_dryland_cVeg_2011_2018_extended.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/ORCHIDEE-CNP_dryland_cVeg_2011_2018_contained.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/ORCHIDEE-CNP_dryland_cVeg_1901_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcLitter,"D:/Driving_C/DGVM/DGVMdrylandTS/cLitter/ORCHIDEE-CNP_dryland_cLitter_1901_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcCwd,"D:/Driving_C/DGVM/DGVMdrylandTS/cCwd/ORCHIDEE-CNP_dryland_cCwd_1901_2018.csv",sep=",",row.names = F)
