...
#contnrlist <- c(1,6,3,4)#number in continent shapefiles
  ...
  cSoilmodelpath <- 'ORCHIDEE_S2_cSoil.nc'
  ...
  PMLdatamask[PMLdatamask ==0] <- NA
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/ORCHIDEE_S2_dryland_GPP_2003_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcSoil,"D:/Driving_C/DGVM/DGVMdrylandTS/cSoil/ORCHIDEE_S2_dryland_cSoil_1901_2018.csv",sep=",",row.names = F)