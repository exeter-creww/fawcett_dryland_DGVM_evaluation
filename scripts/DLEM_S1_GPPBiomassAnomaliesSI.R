...
GPPstack <- stack("D:/Driving_C/PMLV2sampled/PMLv2GPPstack10knew.tif")
  ...
  gppmodelpath <- 'DLEM_S1_gpp.nc'
  cVegmodelpath <- 'DLEM_S1_cVeg.nc'
  cLittermodelpath <- 'DLEM_S1_cLitter.nc'
  lcpath <- 'DLEM_landArea.nc'
  cCwdmodelpath <- 'DLEM_S1_cCwd.nc'
  ...
  #for DLEM_S1 this is area per grid cell not fraction
  lcfraster <- t(raster(landcoverfrac))
  
  modelgppbrick <- t(brick(modelgpp))#no flip  needed for DLEM_S1
  ...
  write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/DLEM_S1_dryland_GPP_1901_2018.csv",sep=",",row.names = F)
  ...
  write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/DLEM_S1_dryland_GPP_2003_2018_extended.csv",sep=",",row.names = F)
  ...
  write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/DLEM_S1_dryland_GPP_2003_2018_contained.csv",sep=",",row.names = F)
  ...
  write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/DLEM_S1_dryland_cVeg_2011_2018.csv",sep=",",row.names = F)
  ...
  write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/DLEM_S1_dryland_cVeg_2011_2018_extended.csv",sep=",",row.names = F)
  ...
  write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/DLEM_S1_dryland_cVeg_2011_2018_contained.csv",sep=",",row.names = F)
  ...
  write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/DLEM_S1_dryland_cVeg_1901_2018.csv",sep=",",row.names = F)
  ...
  write.table(dfdrylandcLitter,"D:/Driving_C/DGVM/DGVMdrylandTS/cLitter/DLEM_S1_dryland_cLitter_1901_2018.csv",sep=",",row.names = F)
  ...
  write.table(dfdrylandcCwd,"D:/Driving_C/DGVM/DGVMdrylandTS/cCwd/DLEM_S1_dryland_cCwd_1901_2018.csv",sep=",",row.names = F)
