...
#contnrlist <- c(1,6,3,4)#number in continent shapefiles
  ...
  cVegmodelpath <- 'LPJ-GUESS_S3_cVeg.nc'
  #lcpath <- 'OCN_S3_oceanCoverFrac.nc'
  cSoilmodelpath <- 'LPJ-GUESS_S3_cSoil.nc'
 ...
 # print(lcncin)
  ...
  PMLdatamask[PMLdatamask ==0] <- NA
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/LPJ-GUESS_dryland_GPP_2001_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/LPJ-GUESS_dryland_GPP_2001_2018_extended.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/LPJ-GUESS_dryland_GPP_2001_2018_contained.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/LPJ-GUESS_dryland_cVeg_2011_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/LPJ-GUESS_dryland_cVeg_2011_2018_extended.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/LPJ-GUESS_dryland_cVeg_2011_2018_contained.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/LPJ-GUESS_dryland_cVeg_1901_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcSoil,"D:/Driving_C/DGVM/DGVMdrylandTS/cSoil/LPJ-GUESS_dryland_cSoil_1901_2018.csv",sep=",",row.names = F)