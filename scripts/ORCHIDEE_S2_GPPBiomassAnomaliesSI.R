...
#contnrlist <- c(1,6,3,4)#number in continent shapefiles
  ...
  gppmodelpath <- 'ORCHIDEE_S2_gpp.nc'
  cVegmodelpath <- 'ORCHIDEE_S2_cVeg.nc'
  cLittermodelpath <- 'ORCHIDEE_S2_cLitter.nc'
  ...
  PMLdatamask[PMLdatamask ==0] <- NA
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/ORCHIDEE_S2_dryland_GPP_1901_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/ORCHIDEE_S2_dryland_GPP_2003_2018_extended.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/ORCHIDEE_S2_dryland_GPP_2003_2018_contained.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/ORCHIDEE_S2_dryland_cVeg_2011_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/ORCHIDEE_S2_dryland_cVeg_2011_2018_extended.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/ORCHIDEE_S2_dryland_cVeg_2011_2018_contained.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/ORCHIDEE_S2_dryland_cVeg_1901_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcLitter,"D:/Driving_C/DGVM/DGVMdrylandTS/cLitter/ORCHIDEE_S2_dryland_cLitter_1901_2018.csv",sep=",",row.names = F)
