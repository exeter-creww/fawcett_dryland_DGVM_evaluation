...
GPPstack <- stack("D:/Driving_C/PMLV2sampled/PMLv2GPPstack10knew.tif")
  ...
  gppmodelpath <- 'DLEM_S2_gpp.nc'
  cVegmodelpath <- 'DLEM_S2_cVeg.nc'
  cLittermodelpath <- 'DLEM_S2_cLitter.nc'
  lcpath <- 'DLEM_landArea.nc'
  cCwdmodelpath <- 'DLEM_S2_cCwd.nc'
  ...
  modelcCwd <- ncvar_get(ncincCwd,'CWDC')#,start=c(1,1,(102*12)+1),count=c(nlonDGVM,nlatDGVM,192))
  ...
  landcoverfrac <- ncvar_get(lcncin,'landArea',start=c(1,1),count=c(nlonDGVM,nlatDGVM))
  
  #for DLEM_S2 this is area per grid cell not fraction
  lcfraster <- t(raster(landcoverfrac))
  
  modelgppbrick <- t(brick(modelgpp))#no flip  needed for DLEM_S2
  ...
  arearaster <- lcfraster/10000 #m2 to hectares
  ...
  write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/DLEM_S2_dryland_GPP_1901_2018.csv",sep=",",row.names = F)
  ...
  write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/DLEM_S2_dryland_GPP_2003_2018_extended.csv",sep=",",row.names = F)
  ...
  write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/DLEM_S2_dryland_GPP_2003_2018_contained.csv",sep=",",row.names = F)
  ...
  write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/DLEM_S2_dryland_cVeg_2011_2018.csv",sep=",",row.names = F)
  ...
  write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/DLEM_S2_dryland_cVeg_2011_2018_extended.csv",sep=",",row.names = F)
  ...
  write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/DLEM_S2_dryland_cVeg_2011_2018_contained.csv",sep=",",row.names = F)
  ...
  write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/DLEM_S2_dryland_cVeg_1901_2018.csv",sep=",",row.names = F)
  ...
  write.table(dfdrylandcLitter,"D:/Driving_C/DGVM/DGVMdrylandTS/cLitter/DLEM_S2_dryland_cLitter_1901_2018.csv",sep=",",row.names = F)
  ...
  write.table(dfdrylandcCwd,"D:/Driving_C/DGVM/DGVMdrylandTS/cCwd/DLEM_S2_dryland_cCwd_1901_2018.csv",sep=",",row.names = F)
