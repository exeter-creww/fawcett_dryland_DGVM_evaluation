...
#contnrlist <- c(1,6,3,4)#number in continent shapefiles
  ...
  gppmodelpath <- 'CABLE-POP_S1_gpp.nc'
  cVegmodelpath <- 'CABLE-POP_S1_cVeg.nc'
  #lcpath <- 'OCN_S3_oceanCoverFrac.nc'
  cLittermodelpath <- 'CABLE-POP_S1_cLitter.nc'
  cCwdmodelpath <- 'CABLE-POP_S1_cCwd.nc'
 ...
 # nc_close(lcncin)
  ...
  PMLdatamask[PMLdatamask ==0] <- NA
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/CABLE-POP_S1_dryland_GPP_1901_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/CABLE-POP_S1_dryland_GPP_2003_2018_extended.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/CABLE-POP_S1_dryland_GPP_2003_2018_contained.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/CABLE-POP_S1_dryland_cVeg_2011_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/CABLE-POP_S1_dryland_cVeg_2011_2018_extended.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/CABLE-POP_S1_dryland_cVeg_2011_2018_contained.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/CABLE-POP_S1_dryland_cVeg_1901_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcLitter,"D:/Driving_C/DGVM/DGVMdrylandTS/cLitter/CABLE-POP_S1_dryland_cLitter_1901_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcCwd,"D:/Driving_C/DGVM/DGVMdrylandTS/cCwd/CABLE-POP_S1_dryland_cCwd_1901_2018.csv",sep=",",row.names = F)
