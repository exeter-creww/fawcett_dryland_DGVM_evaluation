...
GPPstack <- stack("D:/Driving_C/PMLV2sampled/PMLv2GPPstack10knew.tif")
  ...
  cSoilmodelpath <- 'DLEM_S3_cSoil.nc'
  ...
  write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/DLEM_dryland_GPP_2003_2018.csv",sep=",",row.names = F)
  ...
  write.table(dfdrylandcSoil,"D:/Driving_C/DGVM/DGVMdrylandTS/cSoil/DLEM_dryland_cSoil_1901_2018.csv",sep=",",row.names = F)
