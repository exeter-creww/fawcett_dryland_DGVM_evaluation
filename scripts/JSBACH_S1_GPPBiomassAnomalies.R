...
GPPstack <- stack("D:/Driving_C/PMLV2sampled/PMLv2GPPstack10knew.tif")
  ...
  gppmodelpath <- 'JSBACH_S3_gpp.nc'
  cVegmodelpath <- 'JSBACH_S1_cVeg.nc'
  #lcpath <- 'OCN_S3_oceanCoverFrac.nc'
  cSoilmodelpath <- 'JSBACH_S1_cSoil.nc'
 ...
 # nc_close(lcncin)
  ...
  PMLdatamask[PMLdatamask ==0] <- NA
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/JSBACH_S1_dryland_GPP_2003_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcSoil,"D:/Driving_C/DGVM/DGVMdrylandTS/cSoil/JSBACH_S1_dryland_cSoil_1901_2018.csv",sep=",",row.names = F)
