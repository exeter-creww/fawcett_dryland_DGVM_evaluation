...
#contnrlist <- c(1,6,3,4)#number in continent shapefiles
  ...
  cLittermodelpath <- 'CLASS-CTEM_S3_cLitter.nc'
 ...
 # nc_close(lcncin)
  ...
  PMLdatamask[PMLdatamask ==0] <- NA
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/CLASS-CTEM_dryland_cVeg_2011_2018_extended.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/CLASS-CTEM_dryland_cVeg_2011_2018_contained.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcLitter,"D:/Driving_C/DGVM/DGVMdrylandTS/cLitter/CLASS-CTEM_dryland_cLitter_1901_2018.csv",sep=",",row.names = F)
