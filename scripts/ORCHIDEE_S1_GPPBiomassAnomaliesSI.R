...
#contnrlist <- c(1,6,3,4)#number in continent shapefiles
  ...
  gppmodelpath <- 'ORCHIDEE_S1_gpp.nc'
  cVegmodelpath <- 'ORCHIDEE_S1_cVeg.nc'
  cLittermodelpath <- 'ORCHIDEE_S1_cLitter.nc'
  lcpath <- 'ORCHIDEE_S3_oceanCoverFrac.nc'
  ...
  landcoverfrac <- abs(ncvar_get(lcncin,'oceanCoverFrac')-1)
  ...
  modelannualgpp <- t(raster::flip(modelannualgpp,1))#no flip  needed for DLEM
  ...
  PMLdatamask[PMLdatamask ==0] <- NA
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/ORCHIDEE_S1_dryland_GPP_1901_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/ORCHIDEE_S1_dryland_GPP_2003_2018_extended.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/ORCHIDEE_S1_dryland_GPP_2003_2018_contained.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/ORCHIDEE_S1_dryland_cVeg_2011_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/ORCHIDEE_S1_dryland_cVeg_2011_2018_extended.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/ORCHIDEE_S1_dryland_cVeg_2011_2018_contained.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/ORCHIDEE_S1_dryland_cVeg_1901_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcLitter,"D:/Driving_C/DGVM/DGVMdrylandTS/cLitter/ORCHIDEE_S1_dryland_cLitter_1901_2018.csv",sep=",",row.names = F)
