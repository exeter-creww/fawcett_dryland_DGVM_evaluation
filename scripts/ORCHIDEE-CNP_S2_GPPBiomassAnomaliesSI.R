...
#contnrlist <- c(1,6,3,4)#number in continent shapefiles
  ...
  gppmodelpath <- 'ORCHIDEE-CNP_S2_gpp.nc'
  cVegmodelpath <- 'ORCHIDEE-CNP_S2_cVeg.nc'
  cLittermodelpath <- 'ORCHIDEE-CNP_S2_cLitter.nc'
  cCwdmodelpath <- 'ORCHIDEE-CNP_S2_cCwd.nc'
  
  #lcpath <- 'ORCHIDEE-CNP_S2_S3_oceanCoverFrac.nc'
  ...
  modelgpp <- ncvar_get(ncingpp,'gpp',start=c(1,1,(200*12)+1),count=c(nlonDGVM,nlatDGVM,1416))
  ...
  modelgppbrick <- brick(modelgpp)
  modelcVegVODcompbrick <-  t((brick(modelcVegVODcomp)))
  modelcVegbrick <-  t((brick(modelcVeg)))
  modelcLitterbrick <-  t((brick(modelcLitter)))
  modelcCwdbrick <-  t((brick(modelcCwd)))
  ...
  modelannualgpp <- t(modelannualgpp)
  extent(modelannualgpp) <- c(-180, 180, -90, 90)
  projection(modelannualgpp) <- CRS("+init=epsg:4326")
  ...
  PMLdatamask[PMLdatamask ==0] <- NA
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/ORCHIDEE-CNP_S2_dryland_GPP_1901_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/ORCHIDEE-CNP_S2_dryland_GPP_2003_2018_extended.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/ORCHIDEE-CNP_S2_dryland_GPP_2003_2018_contained.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/ORCHIDEE-CNP_S2_dryland_cVeg_2011_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/ORCHIDEE-CNP_S2_dryland_cVeg_2011_2018_extended.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/ORCHIDEE-CNP_S2_dryland_cVeg_2011_2018_contained.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/ORCHIDEE-CNP_S2_dryland_cVeg_1901_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcLitter,"D:/Driving_C/DGVM/DGVMdrylandTS/cLitter/ORCHIDEE-CNP_S2_dryland_cLitter_1901_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcCwd,"D:/Driving_C/DGVM/DGVMdrylandTS/cCwd/ORCHIDEE-CNP_S2_dryland_cCwd_1901_2018.csv",sep=",",row.names = F)
