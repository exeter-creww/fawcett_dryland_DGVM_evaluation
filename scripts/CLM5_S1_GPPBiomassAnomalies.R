...
GPPstack <- stack("./PMLV2sampled/PMLv2GPPstack10knew.tif")
 ...
 # nc_close(lcncin)
  ...
  PMLdatamask[PMLdatamask ==0] <- NA
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/CLM5.0_S1_dryland_GPP_2003_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/CLM5.0_S1_dryland_cVeg_2011_2018_contained.csv",sep=",",row.names = F)
    ...
    write.table(dfdrylandcSoil,"D:/Driving_C/DGVM/DGVMdrylandTS/cSoil/CLM5.0_S1_dryland_cSoil_1901_2018.csv",sep=",",row.names = F)
