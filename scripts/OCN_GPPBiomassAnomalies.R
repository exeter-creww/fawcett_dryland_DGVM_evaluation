...
#contnrlist <- c(1,6,3,4)#number in continent shapefiles
  ...
  cSoilmodelpath <- 'OCN_S3_cSoil.nc'
  ...
  PMLdatamask[PMLdatamask ==0] <- NA
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/OCN_dryland_GPP_2001_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/OCN_dryland_GPP_2001_2018_extended.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/OCN_dryland_GPP_2001_2018_contained.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcSoil,"D:/Driving_C/DGVM/DGVMdrylandTS/cSoil/OCN_dryland_cSoil_1901_2018.csv",sep=",",row.names = F)