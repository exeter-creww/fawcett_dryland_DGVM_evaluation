...
GPPstack <- stack("D:/Driving_C/PMLV2sampled/PMLv2GPPstack10knew_2001_2018_v016.tif")
 ...
 # nc_close(lcncin)
  ...
  PMLdatamask[PMLdatamask ==0] <- NA
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/JSBACH_dryland_GPP_2001_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/JSBACH_dryland_GPP_2001_2018_extended.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/JSBACH_dryland_GPP_2001_2018_contained.csv",sep=",",row.names = F)
