...
#contnrlist <- c(1,6,3,4)#number in continent shapefiles
  ...
  cSoilmodelpath <- 'CLASS-CTEM_S1_cSoil.nc'
 ...
 # nc_close(lcncin)
  ...
  PMLdatamask[PMLdatamask ==0] <- NA
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/CLASS-CTEM_S1_dryland_GPP_2003_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcSoil,"D:/Driving_C/DGVM/DGVMdrylandTS/cSoil/CLASS-CTEM_S1_dryland_cSoil_1901_2018.csv",sep=",",row.names = F)
