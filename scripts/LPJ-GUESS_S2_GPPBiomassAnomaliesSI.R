...
#contnrlist <- c(1,6,3,4)#number in continent shapefiles
  ...
  cLittermodelpath <- 'LPJ-GUESS_S2_cLitter.nc'
  cCwdmodelpath <- 'LPJ-GUESS_S2_cCwd.nc'
 ...
 # print(lcncin)
  ...
  PMLdatamask[PMLdatamask ==0] <- NA
   ...
   write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/LPJ-GUESS_S2_dryland_GPP_1901_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcLitter,"D:/Driving_C/DGVM/DGVMdrylandTS/cLitter/LPJ-GUESS_S2_dryland_cLitter_1901_2018.csv",sep=",",row.names = F)
   ...
   write.table(dfdrylandcCwd,"D:/Driving_C/DGVM/DGVMdrylandTS/cCwd/LPJ-GUESS_S2_dryland_cCwd_1901_2018.csv",sep=",",row.names = F)
