...
GPPstack <- stack("D:/Driving_C/PMLV2sampled/PMLv2GPPstack10knew.tif")
  ...
  lcfraster <- rotate(lcfraster)  #JULES_S2 coordinates go from 0 to 360, raster needs to be shifted
  ...
  PMLdatamask[PMLdatamask ==0] <- NA
   ...
   modelannualcSoilmasked <- modelannualcSoil*10
    ...
    write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/JULES_S2_dryland_GPP_1901_2018.csv",sep=",",row.names = F)
    ...
    write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/JULES_S2_dryland_GPP_2003_2018_extended.csv",sep=",",row.names = F)
    ...
    write.table(dfdrylandGPP,"D:/Driving_C/DGVM/DGVMdrylandTS/GPP/JULES_S2_dryland_GPP_2003_2018_contained.csv",sep=",",row.names = F)
    ...
    write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/JULES_S2_dryland_cVeg_2011_2018.csv",sep=",",row.names = F)
    ...
    write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/JULES_S2_dryland_cVeg_2011_2018_extended.csv",sep=",",row.names = F)
    ...
    write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/JULES_S2_dryland_cVeg_2011_2018_contained.csv",sep=",",row.names = F)
    ...
    write.table(dfdrylandcVeg,"D:/Driving_C/DGVM/DGVMdrylandTS/cVeg/JULES_S2_dryland_cVeg_1901_2018.csv",sep=",",row.names = F)
    ...
    write.table(dfdrylandcSoil,"D:/Driving_C/DGVM/DGVMdrylandTS/cSoil/JULES_S2_dryland_cSoil_1901_2018.csv",sep=",",row.names = F)
